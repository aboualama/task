      ...
      <div class="box">
        ...
        <div class="box-body">
          <table id="example2" class="table table-bordered table-hover"> 
            ...
            {!! Form::open(['url' => 'admin/subcategory/edit/'.$subcategory->id , 'class' => 'form-group' , 'files' => true]) !!}
                {{ method_field('PUT') }}
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class=" ">
                                <input id="description" type="text" class="form-control" name="description" value="{{ $subcategory->description }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('keywords') ? ' has-error' : '' }}">
                            ...
                            <div class=" ">
                                <input id="keywords" type="text" class="form-control" name="keywords" value="{{ $subcategory->keywords  }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('r_title') ? ' has-error' : '' }}">
                            ...
                            <div class=" "> 
                                <textarea id="r_title" type="text" class="form-control ckeditor" name="r_title" value="" >{{ $subcategory->r_title  }}  </textarea>
                        ...
                        <div class="form-group{{ $errors->has('l_title') ? ' has-error' : '' }}">
                            ...
                            <div class=" "> 
                                <textarea id="l_title" type="text" class="form-control ckeditor" name="l_title" value="" >  {{ $subcategory->l_title  }}</textarea>
